...
function renderCircles2(abbrText, newXScale, chosenXaxis) {
...
d3.csv("../data/data.csv", function(err, csvData) {
  ...
  var yLinearScale = d3.scaleLinear()
    .domain([d3.min(csvData, d => d.obesity) * 0.8, d3.max(csvData, d => d.obesity) * 1.2])
    .range([height, 0]);
  ...
  labelsGroup.selectAll("text")
    .on("click", function() {
      ...
      if (value !== chosenXAxis) {
        ...
        abbrText = renderCircles2(abbrText, xLinearScale, chosenXAxis);
